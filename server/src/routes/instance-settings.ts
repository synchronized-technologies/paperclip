        ...
        companyIds.map((companyId) =>
          logActivity(db, {
            ...
            details: {
              ...
              sourceRecoveryActionsOpened: result.sourceRecoveryActionsOpened,
              existingSourceRecoveryActions: result.existingSourceRecoveryActions,
              resolvedUnchangedSourceRecoveryActions: result.resolvedUnchangedSourceRecoveryActions,
              skippedOutsideLookback: result.skippedOutsideLookback,
              escalationIssueIds: result.escalationIssueIds,
              recoveryActionIds: result.recoveryActionIds,
            },
          }),
        ),
      );
