...
export const issueStatusIcon: Record<string, string> = {
  ...
  qa_pending: "text-amber-600 border-amber-600 dark:text-amber-400 dark:border-amber-400",
  qa_in_progress: "text-orange-600 border-orange-600 dark:text-orange-400 dark:border-orange-400",
  qa_failed: "text-rose-600 border-rose-600 dark:text-rose-400 dark:border-rose-400",
  qa_passed: "text-teal-600 border-teal-600 dark:text-teal-400 dark:border-teal-400",
...
export const issueStatusText: Record<string, string> = {
  ...
  qa_pending: "text-amber-600 dark:text-amber-400",
  qa_in_progress: "text-orange-600 dark:text-orange-400",
  qa_failed: "text-rose-600 dark:text-rose-400",
  qa_passed: "text-teal-600 dark:text-teal-400",
...
export const statusBadge: Record<string, string> = {
  ...
  qa_pending: "bg-amber-100 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300",
  qa_in_progress: "bg-orange-100 text-orange-700 dark:bg-orange-900/50 dark:text-orange-300",
  qa_failed: "bg-rose-100 text-rose-700 dark:bg-rose-900/50 dark:text-rose-300",
  qa_passed: "bg-teal-100 text-teal-700 dark:bg-teal-900/50 dark:text-teal-300",
